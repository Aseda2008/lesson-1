...
//         className="block py-2.5 ps-6 pe-0 w-[400px] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none mt-[10px] dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" 
...
//         <input type="text" 
//         id="floating-phone-number" 
//         className="block py-2.5 ps-6 pe-0 w-[400px] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 mt-[10px] appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
//         pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" 
